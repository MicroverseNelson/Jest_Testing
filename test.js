const { stringLength, validateString, reverseString, Calculator, capitalizeFirst } = require("./testingTaskChallenge");
...
describe("Capitalize First", function () {
  test("capitalizeFirst should return the first character of a string in uppercase", () => {
    expect(capitalizeFirst("hello")).toBe("Hello");
  });

  test("error: capitalizeFirst should return the first character of a string in uppercase", () => {
